                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="status" class="form-control @error('status') is-invalid @enderror">
                                        @foreach(trans('product_statuses') as $productStatusKey => $productStatusValue)
                                            <option value="{{ $productStatusKey }}" {{ (old('status') == $productStatusKey) ? 'selected' : '' }}>{{ $productStatusValue }}</option>
                                        @endforeach
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input id="code" type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}"/>
                                    @error('code')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    @enderror
                                    <img id="prevImg" class="img-thumbnail image-width mt-2 mb-2 setting-logo" src="{{ asset('img/item.png') }}" alt="">
                                </div>
