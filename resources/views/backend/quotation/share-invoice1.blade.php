                                ...
                                <table class="table table-striped table-sm">
                                    ...
                                    <tbody>
                                        @if(!blank($quotation->products))
                                            @foreach($quotation->products as $productIem)
                                                <tr>
                                                    <td>
                                                        <span class="font-weight-bold">{{ optional($productIem->product)->name }}</span>
                                                    </td>
                                                    <td>{{ $productIem->quantity }}</td>
                                                    <td>{{ green_number_format($productIem->unit_price) }}</td>
                                                    <td class="text-right">{{ green_number_format($productIem->subtotal_amount) }}</td>
                                                </tr>
                                            @endforeach
                                        @endif
                                        <tr>
