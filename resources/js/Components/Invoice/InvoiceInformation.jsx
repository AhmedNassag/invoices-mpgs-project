...
export default function InvoiceInformation() {
    const {users, isEditPage, invoice} = usePage().props;

    const {items, taxes, discountAmount, deliveryCharge} = useInvoice();
    ...
    const updateInvoice = (e) => {
        ...
        router.put('/invoice/' + invoice.id, formData, {
            onSuccess: () => {
                toast.success("The invoice update successfully");
            }
        });
    }
    ...
    useEffect(() => {
        if (invoice) {
            ...
            const selectedUser = users.find((user) => {
                return user.value === invoice.user_id;
            });
        ...
        <div className="card shadow">
                    ...
                    <div className="col-sm-12">
                        <div className="form-group">
                            <div className="d-flex justify-content-between mb-2 align-content-center">
                                ...
                                <button data-toggle="modal" data-target="#addQuickUser" type="button" className="btn btn-primary btn-sm">
            ...
            <div className="card-footer">
                <button type="submit" className="btn btn-primary btn-block"
                        onClick={isEditPage ? updateInvoice : saveInvoice}>
                    {isEditPage ? 'Update' : 'Create'} Invoice
                </button>
            </div>
